...
public abstract class ATUserDataSource {
    ...
    public abstract ATUserInfoResponse getUserInfo(String userID, AuthenticationInfo authenticationInfo, Parameters params);
     ...
     */
    public abstract ATUserInfoResponse checkForUser(String userID, String source, AuthenticationInfo authenticationInfo, Parameters params);
     ...
     * @param params any additional url parameters
     */
    public abstract void createUserEvent(ATUser user, AuthenticationInfo authenticationInfo, Parameters params);
     ...
     * @param params any additional url parameters
     */
    public abstract void updateUserEvent(ATUser user, AuthenticationInfo authenticationInfo, Parameters params);
     ...
     * @param params any additional url parameters
     */
    public abstract void deleteUserEvent(ATUser user, AuthenticationInfo authenticationInfo, Parameters params);
