...
public class ATUserInfoResponse extends ATResponse {
    ...
    public static class Builder {
        ...
        /**
         * Sets the authorization error to true
         * @param message a String message about the authorization error
         * @return the builder
         */
        ...
        public ATUserInfoResponse build() {
            ...
            jsonObject.putOpt("firstName", firstName);
            jsonObject.putOpt("lastName", lastName);
