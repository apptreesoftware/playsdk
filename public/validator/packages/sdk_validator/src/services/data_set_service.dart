...
class DatasetService extends BaseService {
  ...
  static List<http.MultipartFile> _flattenAttachments(DataSetItem item) {
    ...
    for (var subItem in item.subItems) {
      ...
      if (_isExistingImage(imageData)) continue;
      var fileData = _getAttribute(subItem, AttachmentAttributeIndex.file);
  ...
  Future<ListResponse> getList(Uri connectorUri, String listName) async {
    var uri = connectorUri.replace(pathSegments: ['list', listName], queryParameters: {'json': 'true'});
