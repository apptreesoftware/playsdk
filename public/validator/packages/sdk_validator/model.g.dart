...
AppConfig _$AppConfigFromJson(Map json) =>
    new AppConfig(json['core_host'], json['username'], json['mock']);
...
Endpoint _$EndpointFromJson(Map json) =>
    new Endpoint(json['endpoint'], json['name'], json['type'], json['url']);
...
// **************************************************************************
// Generator: JsonSerializableGenerator
// Target: class ListResponse
// **************************************************************************

ListResponse _$ListResponseFromJson(Map json) => new ListResponse(
    json['success'],
    json['message'],
    json['showMessageAsAlert'],
    (json['records'] as List)
        ?.map((v0) => v0 == null ? null : new ListItem.fromJson(v0))
        ?.toList());

abstract class _$ListResponseSerializerMixin {
  bool get success;
  String get message;
  bool get showMessageAsAlert;
  List get records;
